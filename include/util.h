...
{
template<typename T>
int deinterleaveArray(std::vector<T> &input, std::vector<std::vector<T>> &output, size_t numChannels){
    //test for right size
...
template<typename T>
int interleaveAudio(std::vector<std::vector<T>> &input, std::vector<T> &output){
